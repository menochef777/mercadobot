...
<head>
  ...
  <title>GestorMercado — Gestão completa para o seu mercadinho</title>
  
  <!-- Google Fonts: Manrope, Cabin, Instrument Serif, Inter -->
  <link rel="preconnect" href="https://fonts.googleapis.com">
  <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
  <link href="https://fonts.googleapis.com/css2?family=Cabin:ital,wght@0,400..700;1,400..700&family=Instrument+Serif:ital@0;1&family=Inter:wght@300;400;500;600;700&family=Manrope:wght@400;500;600;700;800&display=swap" rel="stylesheet">
...
<body class="overflow-x-hidden antialiased selection:bg-[#4ade80] selection:text-[#14532d]">
  <div id="root"></div>
  ...
  <script type="text/babel">
    ...
    const TruckIcon = ({ className = "w-8 h-8" }) => (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    function GestorMercadoLandingPage() {
      const [mobileMenuOpen, setMobileMenuOpen] = useState(false);
      const [dropdownOpen, setDropdownOpen] = useState(false);

      return (
        <div className="relative min-h-screen w-full bg-black text-white font-inter antialiased overflow-x-hidden">
          {/* ========================================================================= */}
          ...
          <section className="relative min-h-screen w-full flex flex-col justify-between overflow-hidden">
            ...
            <header className="relative z-20 w-full flex items-center justify-between px-6 md:px-[120px] py-[16px] bg-transparent">
              {/* Logo Esquerda */}
              <a href="#inicio" className="flex items-center gap-2.5 text-white no-underline group focus:outline-none">
              ...
              <nav className="hidden md:flex items-center gap-8 font-manrope text-[15px] font-medium text-white/90">
                ...
                <a href="/api-docs" target="_blank" className="transition-colors hover:text-[#4ade80] drop-shadow-sm">
                  Documentação API
                </a>
              </nav>
            ...
            {mobileMenuOpen && (
              <div className="fixed inset-0 z-50 bg-black/95 backdrop-blur-2xl flex flex-col justify-between p-6 md:hidden">
                ...
                <nav className="flex flex-col gap-6 font-manrope text-2xl font-bold text-neutral-200 my-auto">
                  <a href="#inicio" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#4ade80] transition-colors">
                    Início
                  </a>
                  <a href="#funcionalidades" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#4ade80] transition-colors">
                    Funcionalidades
                  </a>
                  <a href="#como-funciona" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#4ade80] transition-colors">
                    Como funciona
                  </a>
                  <a href="/api-docs" onClick={() => setMobileMenuOpen(false)} className="hover:text-[#4ade80] transition-colors">
                    Documentação API
                  </a>
                </nav>

                <div className="flex flex-col gap-3 pt-6 border-t border-neutral-800">
                  <a href="/api-docs" className="w-full font-cabin font-bold py-3.5 bg-white text-black rounded-[8px] text-center">
                    Entrar
                  </a>
                  <a href="#funcionalidades" onClick={() => setMobileMenuOpen(false)} className="w-full font-cabin font-bold py-3.5 bg-[#4ade80] text-[#14532d] rounded-[8px] text-center shadow-lg shadow-[#4ade80]/20">
                    Começar grátis
                  </a>
                </div>
              </div>
            ...
            <div className="relative z-10 flex flex-col items-center text-center px-4 sm:px-6 max-w-5xl mx-auto mt-32 pb-24">
              ...
              {/* Headline */}
              <h1 className="font-instrument text-5xl sm:text-7xl md:text-[96px] text-white leading-[1.1] tracking-tight max-w-4xl drop-shadow-md mb-6">
                Gerencie seu mercadinho com facilidade <span className="italic font-normal text-[#4ade80]">e</span> sem papel
              </h1>
          ...
          <section id="funcionalidades" className="relative z-20 w-full bg-white text-gray-900 py-24 px-6 md:px-[120px]">
            <div className="max-w-7xl mx-auto">
              ...
              <div className="text-center max-w-2xl mx-auto mb-16">
                ...
                <h2 className="font-instrument text-4xl sm:text-5xl text-gray-950 leading-tight mb-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div className="group relative p-8 rounded-2xl bg-gray-50 border border-gray-200/80 hover:border-[#4ade80] hover:bg-white transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1">
                  ...
                  <p className="font-inter text-gray-600 text-[15px] leading-relaxed mb-6">
                    Cadastre clientes, anote débitos pelo celular e dê baixa com um clique. Notificações automáticas e controle por cliente.
                  </p>
                ...
                <div className="group relative p-8 rounded-2xl bg-gray-50 border border-gray-200/80 hover:border-[#4ade80] hover:bg-white transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1">
                  ...
                  <ul className="space-y-2.5 font-inter text-sm text-gray-600 border-t border-gray-200/60 pt-4">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircleIcon className="w-4 h-4 text-[#14532d]" />
                      Cálculo de déficit de reposição
                    </li>
                  </ul>
                </div>
                ...
                <div className="group relative p-8 rounded-2xl bg-gray-50 border border-gray-200/80 hover:border-[#4ade80] hover:bg-white transition-all duration-300 shadow-sm hover:shadow-xl hover:-translate-y-1">
                  ...
                  <ul className="space-y-2.5 font-inter text-sm text-gray-600 border-t border-gray-200/60 pt-4">
                    ...
                    <li className="flex items-center gap-2">
                      <CheckCircleIcon className="w-4 h-4 text-[#14532d]" />
                      Histórico e valor da última entrega
                    </li>
                  </ul>
                </div>
              </div>
          ...
          {/* ========================================================================= */}
          <section id="como-funciona" className="relative z-20 w-full bg-gray-100 text-gray-900 py-24 px-6 md:px-[120px] border-y border-gray-200/80">
            <div className="max-w-7xl mx-auto">
              {/* Cabeçalho da Seção */}
              <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="p-8 md:p-12 rounded-3xl bg-[#14532d] text-white flex flex-col md:flex-row items-center justify-between gap-8 shadow-2xl relative overflow-hidden">
                ...
                <div className="relative z-10 max-w-xl">
                  <h3 className="font-instrument text-3xl sm:text-4xl text-white mb-2">
          ...
          <footer className="w-full bg-neutral-950 border-t border-neutral-800 py-12 px-6 md:px-[120px] text-neutral-400 text-sm">
            <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
              ...
              <p className="text-center md:text-left text-xs text-neutral-500">
                © 2026 GestorMercado. Todos os direitos reservados. Feito para pequenos comércios e mercadinhos.
              </p>
    ...
    ReactDOM.createRoot(document.getElementById('root')).render(<GestorMercadoLandingPage />);
  </script>
</body>
</html>`);
});
