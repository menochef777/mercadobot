...
INSERT INTO "new_Product" ("barcode", "categoryCategoryId", "costPrice", "description", "discount", "imgURL", "name", "price", "productId", "sku", "stockQuantity", "weight") SELECT "barcode", "categoryCategoryId", "costPrice", "description", "discount", "imgURL", "name", "price", "productId", "sku", "stockQuantity", "weight" FROM "Product";
DROP TABLE "Product";
